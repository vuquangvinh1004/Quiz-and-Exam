...
Quiz Builder Module là module cho phép người dùng tạo, chỉnh sửa, xem trước và quản lý bài kiểm tra theo mẫu chuẩn. Module phải hỗ trợ nhiều loại câu hỏi, sinh bố cục đề thi sạch, đồng thời tự động tạo phần hướng dẫn, phiếu trả lời phù hợp theo mode, đáp án và quy định chấm điểm dựa trên dữ liệu bài kiểm tra.
...
- sinh phiếu trả lời, đáp án và thang điểm phù hợp với loại đề
...
Module phải hỗ trợ tối thiểu 5 nhóm câu hỏi sau:
...
### 5.5. Constructed Response Questions (CRQ)

CRQ là family chứa 2 subtype:
...
- dùng chung luồng nhập/xuất và rubric
- giữ subtype riêng để thống kê và quy tắc hiển thị khác nhau
- câu trả lời có thể nằm ngay sau câu hỏi hoặc trong rubric/đáp án

Dữ liệu bắt buộc:

- nội dung câu hỏi
- subtype `ES` hoặc `PR`
- danh sách đáp án chấp nhận hoặc rubric
- điểm số
...
- Là giảng viên, tôi muốn thêm nhiều loại câu hỏi trong cùng một đề để phù hợp với mục tiêu đánh giá, bao gồm cả CRQ family.
...
Người dùng tạo được bài kiểm tra hỗn hợp gồm các loại câu hỏi cơ bản và CRQ family.
...
Tạo đề gồm các loại câu hỏi cơ bản và CRQ family.
Kỳ vọng:
...
- hỗ trợ đầy đủ 4 loại câu hỏi cơ bản và CRQ family
